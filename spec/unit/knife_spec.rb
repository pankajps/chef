...
describe Chef::Knife do
  ...
  describe "the headers include X-Remote-Request-Id" do
    ...
    let(:monkey_uri) { URI.parse("https://api.opscode.piab/organizations/ponyville/monkey") }
    ...
    it "confirms that the headers include X-Remote-Request-Id" do
      Net::HTTP::Get.should_receive(:new).with("/organizations/ponyville/monkey", headers).and_return(request_mock)
